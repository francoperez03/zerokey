  ...
  return (
    <div>
      <div className="flex flex-col gap-4 h-[450px] w-96 p-4 justify-center items-center bg-slate-50 rounde shadow-md shadow-gray-500">
        ...
        <p>Amount Pay <span className="font-bold text-lg">$100</span></p>
        ...
        <p className="text-md font-medium">Prueba Generada <span>{generateAlphaNumericCode()}...{generateAlphaNumericCode()}</span></p>
